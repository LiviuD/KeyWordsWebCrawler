    ...
    : base(roleStore) { }
        ...
        public static ApplicationRoleManager Create(IdentityFactoryOptions<ApplicationRoleManager> options, IOwinContext context)
        {
            ...
            if (!roleManager.RoleExists("Admin"))
            {
                ...
                //Create an Admin super user who             
                var user = new ApplicationUser { UserName = "administrator@sympli.com", Email = "administrator@sympli.com" };
                var userManager = context.GetUserManager<ApplicationUserManager>();
                if (!userManager.Users.Any(u => u.UserName == user.UserName || u.Email == user.Email))
                {
                    string userPWD = "Administrator@12345";
                    var superUser = userManager.Create(user, userPWD);
